...
<div class="container p-5">
    <form class="form-horizontal" role="form" method="POST" action="/admin/home/jenisbahan/tambah">
    	{{ csrf_field() }}
        <div class="row">
            <div class="col-md-3"></div>
            <div class="col-md-6">
                <h2>Tambah Jenis Bahan</h2>
                <hr>
            </div>
        </div>
        <div class="row">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="nama_bahan" class="form-control" id="name"
                               placeholder="Kain Paris" required autofocus value='{{ old("nama_bahan") }}'>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
