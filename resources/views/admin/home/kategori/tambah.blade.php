...
<div class="container p-5">
    <form class="form-horizontal" role="form" method="POST" action="/admin/home/kategori/tambah">
    	{{ csrf_field() }}
        <div class="row">
                ...
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <input type="text" name="jenis_kategori" class="form-control" id="name"
                               placeholder="Jumpsuit Batik" required autofocus value='{{ old("jenis_kategori") }}'>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
