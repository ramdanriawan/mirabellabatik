...
<div class="container p-5">
    <form class="form-horizontal" role="form" method="POST" action="register_store">
    	{{ csrf_field() }}
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                        ...
                        <textarea name="email" class="form-control" id="email"
                               placeholder="Alamat" required autofocus></textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
